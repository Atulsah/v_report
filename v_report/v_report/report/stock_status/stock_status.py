...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Production Qty"), "fieldname": "in_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
		{"label": _("Dispatched Qty"), "fieldname": "out_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
		{"label": _("Closing Stock"), "fieldname": "bal_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
		{"label": _("Remaining Stock"), "fieldname": "bal_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
	]
