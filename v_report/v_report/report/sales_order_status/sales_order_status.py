...
def execute(filters=None):
	...
	for i in items:
		...
		data.append([i.customer,i.foreign_buyer_name,i.final_destination,i.item_code,i.item_name,i.p_o_no,i.p_o_date,i.name,i.delivery_date,i.qty,i.delivered_qty,pending_qty,pending_wt,available_qty,required_qty,i.weight_per_unit,i.pcs_per_crate])
	return columns, data
